...
const EMBEDDED_FILES: &[EmbeddedFile] = &[
    ...
    EmbeddedFile { path: "phases/migrate-memory-backfill.md", content: include_str!("../defaults/phases/migrate-memory-backfill.md") },
    ...
    EmbeddedFile { path: "fixed-memory/cli-tool-design.md", content: include_str!("../defaults/fixed-memory/cli-tool-design.md") },
